        ...
        <div class="contar-wrap">
            ...
            <div class="item">
                <div class="item-box  layer-photos-demo1 layer-photos-demo">
                    <h3><a href="article.html"><?php echo htmlentities($article['title']); ?></a></h3>
                ...
                <div class="comment count">
                    ...
                    <span><?php echo htmlentities($article['view']); ?>个阅读</span>
                    <!--<i class="layui-icon layui-icon-dialogue">-->
                    <a href="article.html#comment"><?php echo htmlentities($article['comment']); ?>条评论</a></i>
                </div>
            </div>
