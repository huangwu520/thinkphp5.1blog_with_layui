...
<div class="container-wrap">
    <div class="container">
            ...
            <div class="contar-wrap">
                <h4 class="item-title">
                    <p><i class="layui-icon layui-icon-speaker"></i><?php echo htmlentities($name['name']); ?>&nbsp标签</p>
                </h4>
                ...
                <div class="item">
                    <div class="item-box  layer-photos-demo1 layer-photos-demo">
                        ...
                        <h5>发布于：<span><?php echo htmlentities(friendlyDate($article['create_time'])); ?></span></h5>
